...
public class TagView extends View {
        ...
        public void run() {
            if (!isMoved && !isUp){
                ...
                if (state == ViewDragHelper.STATE_IDLE){
                    ...
                    mOnTagClickListener.onTagLongClick((Integer) getTag(), getText());
                }
            }
        }
    };
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (isEnableCross() && isClickCrossArea(event) && mOnTagClickListener != null){
            if (action == MotionEvent.ACTION_DOWN) {
                mOnTagClickListener.onTagCrossClick((Integer) getTag());
            }
            return true;
            ...
            switch (action){
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!isExecLongClick && !isMoved) {
                        mOnTagClickListener.onTagClick((Integer) getTag(), getText());
                    }
                    break;
            }
            return true;
